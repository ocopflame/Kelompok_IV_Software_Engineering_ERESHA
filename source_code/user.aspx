                            ...
                            <form id="form1" runat="server">
							    ...
							    <div class="card-block">
                                    ...
                                    <h6 class="card-subtitle italic"><asp:Label ID="lblHeader" runat="server" 
                                            Text="Pengguna - Input Data"></asp:Label></h6> 
							    </div>
                                    ...
                                    <asp:panel id="pnlInputData" runat="server" visible="false" >
                                        <div class="form-material m-t-0 row">
							                ...
							                <div class="form-group required col-md-6 m-t-30">
                                                ...
                                                <asp:TextBox ID="txtPassword" runat="server" required=""  class="form-control form-control-line" ></asp:TextBox>
                                            </div>
							                <div class="form-group required col-md-6 m-t-30">
                                                <label>Confirm Password</label>
                                                <asp:TextBox ID="txtConfirmPassword" runat="server" required=""  class="form-control form-control-line" ></asp:TextBox>
                                            </div>
								            <div class="form-group required col-md-6 m-t-30">
