                            ...
                            <form id="form1" runat="server">
							    ...
							    <div class="card-block">
                                    ...
                                    <h6 class="card-subtitle italic"><asp:Label ID="lblHeader" runat="server" 
                                            Text="Agenda Masuk - Input Data"></asp:Label></h6> 
							    </div>
                                ...
                                <div class="card-block">
                                    ...
                                    <asp:panel id="pnlInputData" runat="server" visible="false" >
                                        <div class="form-material m-t-0 row">
							                <div class="form-group required col-md-4 m-t-30">
								            ...
								            <div class="form-group required col-md-4 m-t-30">
									            <label>Bentuk</label>
                                                <asp:DropDownList ID="ddlBentuk" required="" runat="server" 
										    ...
										    <div class="form-group col-md-12 m-t-40 m-b-0">
                                                <filter>Beri Peringatan ke Email:</filter>
										    </div>
							                <div class="form-group col-md-3 m-t-30">
                                                <label>Email</label>
                                                <asp:TextBox ID="txtEmail" runat="server" placeholder="example@example.com" class="form-control form-control-line email-inputmask" ></asp:TextBox>
                                            </div>
							                <div class="form-group col-md-3 m-t-30">
                                                <label>Tanggal</label>
                                                <asp:TextBox ID="txtTglPeringatan" runat="server" class="form-control form-control-line" ></asp:TextBox>
                                            </div>
							                <div class="form-group col-md-6 m-t-30">
                                                <label>Isi Peringatan</label>
                                                <asp:TextBox ID="txtIsiPeringatan" runat="server" class="form-control form-control-line" ></asp:TextBox>
                                            </div>
                                    ...
                                    <asp:panel id="pnlGridData" runat="server" >
                                        ...
                                        <div class="form-material m-t-0 row">
								            ...
								            <div class="form-group col-md-3 m-t-10">
									            <label>Bentuk</label>
                                                <asp:DropDownList ID="ddlFilterBentuk" runat="server" 
                                                    class="form-control form-control-line" >
                                                </asp:DropDownList>								            
                                            </div>
										    <div class="form-group col-md-3 m-t-10">
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="TanggalTerima" SortExpression="TanggalTerima" HeaderText="Tanggal" DataFormatString="{0:d}" />
