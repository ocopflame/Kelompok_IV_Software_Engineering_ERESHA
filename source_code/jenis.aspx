<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jenis.aspx.vb" Inherits="jenis" %>
...
<%--                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Jenis</h3>
                        <ol class="breadcrumb">
                        ...
                        <div class="card">
                            <form id="form1" runat="server">
							    ...
							    <div class="card-block">
                                    <h2 class="card-title">Jenis Dokumen</h2>
                                    <h6 class="card-subtitle italic"><asp:Label ID="lblHeader" runat="server" 
                                            Text="Daftar Jenis Dokumen"></asp:Label></h6> 
							    </div>
                                    ...
                                    <asp:panel id="pnlInputData" runat="server" visible="false" >
                                        <div class="form-material m-t-0 row">
							                <div class="form-group required col-md-6 m-t-30">
                                                <label>Jenis</label>
                                                <asp:TextBox ID="txtJenis" runat="server" required=""  class="form-control form-control-line" ></asp:TextBox>
                                            </div>
								            <div class="form-group required col-md-6 m-t-30">
									            <label>Status</label>
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" OnSorting="gv_Sorting"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="BtnEdit" runat="server" CausesValidation="False"  
                                                                CommandArgument='<%#Eval("JenisID")%>' CommandName="Ubah"   
                                                    ...
                                                    <asp:BoundField DataField="Jenis" SortExpression="Jenis" HeaderText="Jenis Dokumen" />
